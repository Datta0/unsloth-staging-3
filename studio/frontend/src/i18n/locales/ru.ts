  ...
  settings: {
    ...
    resources: {
      ...
      modelMemory: {
        ...
        noRamReserveHint: "Использует DirectIO в поддерживаемых сборках Windows, когда модель полностью выгружена на видеокарту. В остальных случаях сохраняет загрузку через отображение файла в память. Необходимые буферы ЦП и отображённые страницы всё равно могут занимать ОЗУ. Убирает --no-mmap и --mlock.",
