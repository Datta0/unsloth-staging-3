  ...
  settings: {
    ...
    resources: {
      ...
      modelMemory: {
        ...
        noRamReserveHint: "モデルが GPU に完全にオフロードされている場合、対応する Windows ビルドでは DirectIO を使用します。それ以外ではメモリマップ読み込みを維持します。必要な CPU バッファとマップ済みページは RAM を使用することがあります。--no-mmap と --mlock を除去します。",
